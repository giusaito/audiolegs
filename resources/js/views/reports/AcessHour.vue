<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" style="width: 100%" :default-sort="{prop: 'data', order: 'ascending'}">
...
<script>
import { fetchAcessHour } from '@/api/reports';
  ...
  methods: {
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['Data', 'Horário mais acessado', 'Quantidade de acessos'];
        const filterVal = ['data', 'hour_acess', 'qtd_ass'];
        const data = this.formatJson(filterVal, this.list);
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: 'horários mais acessados',
        });
    ...
    async getLaws() {
      ...
      const { data } = await fetchAcessHour(this.listQuery);
